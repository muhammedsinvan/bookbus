        ...
        <div class="ticket-inner">
          <div id="report">
            ...
            <div class="route" >
              ...
              <p>
                <span>{res.busdetail.to}</span>
                <span></span>
              </p>
            </div>
            <div class="time">
            <p><span>Starts</span><span>{moment(res.busdetail.startingdate).format("DD/MM/YYYY")}</span><span>{res.busdetail.startingtime} a.m</span></p>
            <p><span>Arrives</span><span>{moment(res.busdetail.endingdate).format("DD/MM/YYYY")}</span> <span>{res.busdetail.endingtime} p.m</span></p>
            </div>
            <div class="flight">
              <p>
                <span>price</span>
                <span>{res.busdetail.price}</span>
              </p>
              <p>
                <span>Seat</span>
                <span>{res.seat}</span>
