...
const Profile = () => {
  ...
  return (
      <Grid container>
    <Container align="center"  sx={{ width: { xs: "100%", md: "50%" },mt:"13%",minHeight:"80vh" }}>
    <Card sx={{ boxShadow: 5 ,minHeight:400}}>
        <div align="right">
        <Button sx={{m:2}} variant="contained" onClick={editprofile}>Edit</Button>  
        <Button sx={{m:2}} variant="contained" onClick={changepassword}>Change Password</Button>  
        </div>
        ...
        >
            <FormControl>
                ...
                <div>
                    <Typography component="span" sx={{fontWeight:"800"}}>First Name  : </Typography>
                    <Typography component="span" >{data.firstname}</Typography>
                    <br/>
                    <br/>
                    <Typography component="span" sx={{fontWeight:"800"}}>Last Name : </Typography>
                    <Typography component="span">{data.lastname}</Typography>
                    <br/>
                    <br/>
                    <Typography component="span" sx={{fontWeight:"800"}}>Email : </Typography>
                    <Typography component="span">{data.email}</Typography>
                    <br/>
                    <br/>
{ open && <div>
                    <Typography component="span" sx={{fontWeight:"800"}}>Current Password : </Typography>  
        ...
        {error === true && <Typography color="red" sx={{fontSize:'0.8rem',ml:14}} >Enter the correct password</Typography>}
        <br/>
                
                    <Typography component="span" sx={{fontWeight:"800"}}>New Password : </Typography>  
...
<br/>
        <Button sx={{m:2}} variant="contained" onClick={newpassword}>Submit</Button>  
